...
from openpilot.iqpilot.models.runners.tinygrad.model_types import (
  OffPolicyTinygrad,
  OnPolicyTinygrad,
  PolicyTinygrad,
  SupercomboTinygrad,
...
class TinygradRunner(ModelRunner, SupercomboTinygrad, PolicyTinygrad, VisionTinygrad, OffPolicyTinygrad, OnPolicyTinygrad):
  ...
  def _attach_vision_tensor(self, stream_name: str, frame_buffers: CLMemDict, frame_views: FrameDict) -> None:
    ...
    mirrored = frame_views[stream_name].buffer_from_cl(frame_buffer).reshape(self.input_shapes[stream_name])
