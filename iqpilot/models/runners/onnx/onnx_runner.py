...
from openpilot.iqpilot.models.runners.constants import CLMemDict, FrameDict, ModelType, NumpyDict, ShapeDict
...
class ONNXRunner(ModelRunner):
  ...
  def _frame_as_numpy(self, stream_name: str, imgs_cl: CLMemDict, frames: FrameDict) -> np.ndarray:
    flattened = frames[stream_name].buffer_from_cl(imgs_cl[stream_name])
