...
class ControlsExt(ModelStateBase):
  def __init__(self, CP: structs.CarParams, params: Params):
    ...
    self._set_speed_to_limit = self._read_set_speed_to_limit()
  ...
  def state_control_ext(self, sm: messaging.SubMaster) -> custom.IQCarControl:
    ...
    # Steering guidance continuity state
    ss_iq = sm['iqState']
    CC_IQ.aol = ss_iq.aol
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      if self._set_speed_to_limit:
        ...
        self._last_slc_sync_limit_kph = None
        self._pending_slc_sync_limit_kph = None
