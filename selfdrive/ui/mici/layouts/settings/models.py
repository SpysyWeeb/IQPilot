...
class ModelsLayoutMici(NavScroller):
  def __init__(self):
    ...
    self._main_items = [self._current, self._cancel, self._supercombo, self._vision, self._policy, self._refresh, self._clear,
  ...
  def _select_default(self):
    ...
    gui_app.pop_widgets_to(self, callback=self._show_reset_calibration_prompt if default_bundle else (lambda: None))
