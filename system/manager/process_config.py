...
procs += [
  ...
  PythonProcess("iqmapd", "iqpilot.navd.iq_maps_bridge", iqmapd_onroad, restart_if_crash=True),
  ...
  PythonProcess("mapd_manager", "iqpilot.iq_maps.orchestrator", only_offroad),
